    ...
    return (
      <section className="sgcreator-representation_section">
        ...
        <div className="sgcreator-representation_wrapper">
          {Object.keys(this.props.list.featuredList.className).map(
            (item, i) => (
              <div
                className="sgcreator-item-box sgcreator-item-box_feathred-list"
                itemID={i}
                key={i}
              >
                ...
                <div className="sgcreator-tag-box">
                  {`<${this.props.list.featuredList.tag} class="${
